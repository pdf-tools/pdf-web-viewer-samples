...
export default class CustomToolbar {
  ...
  constructor(callbacks?: CustomToolbarCallbacks, options?: CustomToolbarOptions) {
    ...
    this.dom = {
      uploadFileButton: document.getElementById(
        'upload-file-button'
      ) as HTMLButtonElement,
      uploadFileInput: document.getElementById(
        'upload-file-input'
      ) as HTMLInputElement,
      downloadFileButton: document.getElementById(
        'download-file-button'
      ) as HTMLButtonElement,
      toggleInformationPaneButton: document.getElementById(
        'toggle-information-pane-button'
      ) as HTMLButtonElement,
      pageNumberInput: document.getElementById(
        'page-number-input'
      ) as HTMLInputElement,
      pageCount: document.getElementById('page-count') as HTMLSpanElement,
      prevPageButton: document.getElementById(
        'prev-page-button'
      ) as HTMLButtonElement,
      nextPageButton: document.getElementById(
        'next-page-button'
      ) as HTMLButtonElement,
      toggleSearchToolbarButton: document.getElementById(
        'toggle-search-toolbar-button'
      ) as HTMLButtonElement,
      toggleZoomToolbarButton: document.getElementById(
        'toggle-zoom-toolbar-button'
      ) as HTMLButtonElement,
      toggleLayoutToolbarButton: document.getElementById(
        'toggle-layout-toolbar-button'
      ) as HTMLButtonElement,
      searchToolbar: document.getElementById('search-toolbar') as HTMLDivElement,
      searchInput: document.getElementById('search-input') as HTMLInputElement,
      prevSearchMatchButton: document.getElementById(
        'prev-search-match-button'
      ) as HTMLButtonElement,
      nextSearchMatchButton: document.getElementById(
        'next-search-match-button'
      ) as HTMLButtonElement,
      searchOptionsContainer: document.getElementById(
        'search-options'
      ) as HTMLDivElement,
      caseSensitiveSearchCheckbox: document.getElementById(
        'case-sensitive-search-checkbox'
      ) as HTMLInputElement,
      wrapSearchCheckbox: document.getElementById(
        'wrap-search-checkbox'
      ) as HTMLInputElement,
      regularExpressionSearchCheckbox: document.getElementById(
      ...
      zoomDropdownButton: document.querySelector(
        '#zoom-dropdown .dropdown-button'
      ) as HTMLDivElement,
      zoomDropdownOptionsContainer: document.querySelector(
        '#zoom-dropdown .dropdown-options-container'
      ) as HTMLDivElement,
      layoutToolbar: document.getElementById('layout-toolbar') as HTMLDivElement,
      toggleFitButton: document.getElementById(
        'toggle-fit-button'
      ) as HTMLButtonElement,
      rotateViewerButton: document.getElementById(
        'rotate-viewer-button'
      ) as HTMLButtonElement,
      layoutDropdown: document.getElementById('layout-dropdown') as HTMLDivElement,
      layoutDropdownButton: document.querySelector(
        '#layout-dropdown .dropdown-button'
      ) as HTMLDivElement,
      layoutDropdownOptionsContainer: document.querySelector(
        '#layout-dropdown .dropdown-options-container'
      ) as HTMLDivElement,
      layoutDropdownOptions: document.querySelectorAll(
  ...
  private handleLayoutDropdownOptionClicked(event: PointerEvent) {
    ...
    const dropdownValue = this.dom.layoutDropdown.querySelector(
      '.dropdown-value'
    ) as HTMLSpanElement
    dropdownValue.innerText = dropdownOption.innerText
  ...
  private refreshFitModeIcon() {
    const icon = this.dom.toggleFitButton.querySelector(
